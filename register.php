...
if(isset($_POST['submitbtnname']))
{
    ...
    if($password==$repassword){
      $sqlquery = "INSERT INTO admin(username, email, password) VALUES ('$username','$email','$password')";
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="register.php" method="post">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" name="submitbtnname" class="btn btn-primary btn-lg">Register</button>
                  </div>
